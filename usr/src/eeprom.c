...
uint8_t EEPROM_ReadBytes(uint16_t mem_addr, uint8_t *pData, uint16_t len) {
    ...
    LL_I2C_HandleTransfer(I2Cx, EEPROM_I2C_ADDRESS, LL_I2C_ADDRESSING_MODE_7BIT, 2, LL_I2C_MODE_SOFTEND,
    ...
    LL_I2C_HandleTransfer(I2Cx, EEPROM_I2C_ADDRESS, LL_I2C_ADDRESSING_MODE_7BIT, (uint8_t) len, LL_I2C_MODE_AUTOEND,
